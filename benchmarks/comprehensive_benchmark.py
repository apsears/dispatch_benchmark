...
try:
    # Import our benchmarking system
    from virtual_energy.optimisers.benchmark import run_benchmark

    print("Successfully imported run_benchmark")
except ImportError as e:
    print(f"Error importing run_benchmark: {e}")
    traceback.print_exc()
    sys.exit(1)
