...
import sys
import argparse
from virtual_energy.io.ercot import main as ercot_main
...
from virtual_energy.config import get_benchmark_config, get_config
...
def main():
    ...
    ercot_parser = subparsers.add_parser("ercot", help="Run ERCOT data processing")
    ...
    config_parser = subparsers.add_parser("config", help="Display configuration settings")
    config_parser.add_argument(
        "--section",
        help="Specific configuration section to display"
    )
