...
This script uses functionality from the virtual_energy.io.ercot module.
"""
...
from src.virtual_energy.io.ercot import (
    get_id_token, fetch_spp_prices_api, get_months_for_year,
    process_json_file, combine_and_format_data, main as ercot_main
)
